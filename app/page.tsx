...
export default function HomePage() {
  return (
    <>
      ...
      <section style={{background:"#001228",padding:"5rem 2rem"}}>
        <div style={{maxWidth:"1300px",margin:"0 auto"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:"2px",minHeight:"360px"}} className="svc-strip-grid">
            {services.map((s)=>(
      ...
      {/* ══ INDUSTRIES ════════════════════════════════════════ */}
      <section style={{background:"#f5fafa",padding:"4rem 2rem"}}>
        <div style={{maxWidth:"1300px",margin:"0 auto"}}>
      ...
      {/* ══ CLIENTS ═══════════════════════════════════════════ */}
      <section style={{background:"#fff",padding:"3.5rem 2rem",borderTop:"1px solid rgba(0,102,102,0.1)",borderBottom:"1px solid rgba(0,102,102,0.1)"}}>
        <div style={{maxWidth:"1300px",margin:"0 auto"}}>
      ...
      {/* ══ DOWNLOADS STRIP ═══════════════════════════════════ */}
      <section style={{background:"#001e3c",padding:"4rem 2rem",borderTop:"1px solid rgba(0,170,170,0.15)"}}>
        <div style={{maxWidth:"1300px",margin:"0 auto"}}>
