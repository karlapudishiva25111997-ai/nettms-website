...
export default function NETTMSeduPage() {
  return (<>
    ...
    <section style={{background:"#001e3c",padding:"clamp(3rem,5vw,5rem) clamp(1.2rem,4vw,2rem)"}}>
      <div style={{maxWidth:"1300px",margin:"0 auto"}}>
    ...
    <section style={{background:"linear-gradient(135deg,#001e3c,#001e3c)",padding:"clamp(3rem,5vw,5rem) clamp(1.2rem,4vw,2rem)",textAlign:"center",position:"relative",overflow:"hidden"}}>
