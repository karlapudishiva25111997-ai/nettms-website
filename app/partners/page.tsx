...
export const metadata: Metadata = { title: "Partners & Network — Technology, Academic & Ecosystem Partners", description: "NETTMS is part of an integrated digital construction ecosystem connecting design consultants, PMCs, technology platforms, and academic institutions.", alternates: { canonical: "/partners" } };
const techPartners = [{ name:"Autodesk", desc:"ACC, BIM 360, Revit, Navisworks" },{ name:"Esri", desc:"GIS-BIM spatial integration" },{ name:"Bentley Systems", desc:"iTwin infrastructure digital twin" },{ name:"Microsoft Azure", desc:"Cloud governance infrastructure" }];
const ecosystem = [
  ...
  return (<>
    ...
    <section style={{background:"#fff",padding:"5rem 2rem"}}>
      <div style={{maxWidth:"1300px",margin:"0 auto"}}>
        <div className="eyebrow" style={{color:"#006666"}}>Technology Partners</div>
        <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(1.8rem,3vw,2.4rem)",color:"#001e3c",marginBottom:"2rem",fontWeight:600}}>Platform & Technology Partners</h2>
    ...
    <section style={{background:"#001e3c",padding:"5rem 2rem",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:"1300px",margin:"0 auto",position:"relative"}}>
        ...
        <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(1.8rem,3vw,2.4rem)",color:"#fff",marginBottom:"2rem",fontWeight:600}}>How We Work With Each Partner Type</h2>
